<?php
    ...
    $linklist = array(
        ...
        array("name" => "雑貨の店追加", "comment" => "雑貨・日用品の店の追加処理を行えます。", "path" => "../insert_data/goods.php"), 
        array("name" => "雑貨の店削除・編集", "comment" => "登録した雑貨・日用品の店の編集や削除を行えます。", "path" => "../delete_data/goods.php")
    );
?>
<div class="row">
<?php
